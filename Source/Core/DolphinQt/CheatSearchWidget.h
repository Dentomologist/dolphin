...
private:
  ...
  // Stores values used by the "last value" search filter and shown in the Last Value column.
  ...
  // frame event occurs. Overwritten by m_last_value_session (up to the maximum table size) whenever
  // that session updates.
